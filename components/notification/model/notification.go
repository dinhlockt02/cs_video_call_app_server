...
const (
	...
	CallChannel  ChannelKey = "call_channel"
)
...
const (
	...
	ReceiveFriendRequest NotificationActionType = "receive-friend-request"
	ReceiveGroupRequest  NotificationActionType = "receive-group-request"
